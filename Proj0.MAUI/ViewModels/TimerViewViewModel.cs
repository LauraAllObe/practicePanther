...
namespace Proj0.MAUI.ViewModels
{
    public class TimerViewViewModel : INotifyPropertyChanged
    {
        ...
        {
            if(SelectedEmployee != 0 && stopwatch.Elapsed.TotalMinutes > 10)
            {
                TimeService.Current.AddOrEdit(new TimeDTO { Id = 0, Date = DateTime.Now, 
                    Narrative = "Autogenerated narrative.", Hours = stopwatch.Elapsed.TotalHours, 
                    ProjectId = Project.Id, EmployeeId = SelectedEmployee, BillId = -1});
        ...
        {
            Project = new Project(ProjectService.Current.Get(projectId)) ?? new Project();
