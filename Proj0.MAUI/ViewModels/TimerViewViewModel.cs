...
namespace Proj0.MAUI.ViewModels
{
    public class TimerViewViewModel : INotifyPropertyChanged
    {
        ...
        public void ExecuteStop()
        {
                ...
                TimeService.Current.Add(new Time { Id = 0, Date = DateTime.Now, Narrative = "Autogenerated narrative.", Hours = stopwatch.Elapsed.TotalHours, ProjectId = Project.Id, EmployeeId = SelectedEmployee });
            stopwatch.Stop();
        }
